...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Date         1/09/2019 
    Mail          RahulHackz@protonmail.com

* if you need any help, feel free to contact author.
  author
'''%(G,W)
def info_ga():
  ...
  -------------       -------------------------------------
   ...
   get_data                 Fetches all friends data
   get_info                  Show information about your friend

   dump_id                 Fetches all id from friend list
   dump_phone        Fetches all phone number from friend list
   dump_mail            Fetches all emails from friend list
   dump_<id>_id      Fetches all id from your friends <spesific>
		      ex: dump_username_id

   token                      Generate access token
   cat_token              Shows your access token
   rm_token               Remove your access token
   ...
   exit                         Stoops all and exits the Script
'''%(G,W)
def menu_bot():
	print '''
   %sNumber                  INFO%s
...
def get(data):
	...
	try:
		...
		b.close()
		print '[*] We have  SUCCESSFULLY generated access token for you!!!'
		print '[*] Your access token is stored in cookie/token.log'
		exit()
	except KeyError:
		print '[!] Oops! failed to generate access token'
		print '[!] Please check your internet connection / Email or Password and try again'
		...
		main()
def id():
	print '[*] Log in to your Facebook Account       ';id = raw_input('[?] Username : ');pwd = getpass.getpass('[?] Password : ');API_SECRET = '62f8ce9f74b12f84c123cc23437a4a32';data = {"api_key":"882a8490361da98702bf97a021ddc14d","credentials_type":"password","email":id,"format":"JSON", "generate_machine_id":"1","generate_session_cookies":"1","locale":"en_US","method":"auth.login","password":pwd,"return_ssl_resources":"0","v":"1.0"};sig = 'api_key=882a8490361da98702bf97a021ddc14dcredentials_type=passwordemail='+id+'format=JSONgenerate_machine_id=1generate_session_cookies=1locale=en_USmethod=auth.loginpassword='+pwd+'return_ssl_resources=0v=1.0'+API_SECRET
	x = hashlib.new('md5')
        x.update(sig)
...
def unfollow(posts):
	...
	print '\r[*] All the id successfully retrieved    '
	print '[*] Start'
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'RahulHackz' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'RahulHackz' + W +'/' + R +'Bot ' + W + '>> ')
